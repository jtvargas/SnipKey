...
//    @Query(sort: \SnipTag.name) private var tags: [SnipTag]
    ...
    func addTagToSnippet(item: SnippetItem){
        ...
        if tagCreated != nil {
            ...
            let newTagCreated = snippetViewModel.createTag(name: customTagName, iconName: customTagIconName)
...
//                Toggle("Create New Tag", isOn: $isCreatingNewTag)
//                Label("Custom Tag: ", systemImage: "circle")
                ...
                Section(
                    ...
                    CreateOrSelectTag(isCreatingNewTag: $isCreatingNewTag, tagName: $customTagName, tagIcon: $customTagIconName)
        ...
        //        .onDisappear(){
        //            if(isCreatingNewTag){
        //                print("create new tag: \(tagName), \(tagIcon)")
        //                snippetItem.customTag?.name = tagName
        //                snippetItem.customTag?.imageTag = tagIcon
        ////                snippetItem.customTag = newCustomTag
        ////                snippetViewModel.createNewTagAndRelationship(tag: newCustomTag, item: snippetItem)
        //            } else {
        //                print("no create tag")
        //            }
        //        }
