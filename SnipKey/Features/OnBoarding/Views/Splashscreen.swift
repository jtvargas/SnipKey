...
struct Splashscreen: View {
    ...
    var body: some View {
        VStack(alignment: .leading){
            ...
            Text("**Manage** snippets of **text** and **URLs** for seamless use **across all** your **apps**.")
        ...
        .onAppear {
                withAnimation {
                    ...
                    // Simulate progress over the duration of the animations
                        Timer.scheduledTimer(withTimeInterval: totalAnimationDuration / 100, repeats: true) { timer in
